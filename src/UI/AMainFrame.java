...
public class AMainFrame extends javax.swing.JFrame {
    ...
    public AMainFrame() {
        ...
        jPanel1.add(new ADashboard(), "dashboard");
        jPanel1.add(new AManageCource(), "cource");
        jPanel1.add(new AManageProdi(), "prodi");
        jPanel1.add(new AManageFakultas(), "Fakultas");
    ...
    private void initComponents() {
        ...
        Jmenus.add(dashboard);

        jMenu1.setText("University");

        jMenuItem1.setText("Fakultas");
        ...
        jMenuItem4.setText("Program Studi");
        ...
        jMenuItem5.setText("Cource");
        jMenu1.add(jMenuItem5);

        Jmenus.add(jMenu1);

        jMenu3.setText("Graduation");
        Jmenus.add(jMenu3);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AMainFrame().setVisible(true);
            }
        });
    }
